...
using TMPro; // Importa TextMesh Pro
...
public class UIManager : MonoBehaviour
{
  ...
  public TMP_Dropdown marsSatellites;  // Dropdown para los satélites de Marte
  public TMP_Dropdown jupiterSatellites;  // Dropdown para los satélites de Júpiter
  ...
  public void SwitchToOrbitView()
  {
    if (CameraManager.instance.cameraMode.Equals(ConstantValues.CameraMode.Detailed))
    {
      ...
      Debug.Log("Cambiar al modo de vista general");
      ToggleOrbits(true);
      ...
      PlanetManager.instance.DisableSunFlare("Sol");
  ...
  public void ChangeSatellites(string planet)
  {
    switch (planet)
    {
      case "Marte":
        ...
        PlanetManager.instance.EnablePlanet("Marte");
        break;
      case "Jupiter":
